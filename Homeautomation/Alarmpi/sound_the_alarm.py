...
def loop_a(): #open curtians
  time.sleep(20)
  subprocess.call(['sudo', 'python', '/home/pi/Homeautomation/Curtains/Curtains open.py'])
  subprocess.call(['sudo', 'python', '/home/pi/Homeautomation/Blinds/Blinds open gradual.py'])
